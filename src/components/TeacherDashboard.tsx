  ...
  return (
    <div className="h-screen bg-[#f8fafc] flex flex-col overflow-hidden">
            ...
            {activeTab && (
              <div className="flex flex-col ml-20">
                ...
                <p className="text-sm text-gray-500">
                  ...
                  {activeTab === 'budget' && 'Gérez votre budget'}
                </p>
                </div>
            )}
              </div>
      ...
      <div className="flex flex-1 overflow-hidden w-full">
        ...
        <SidebarButton icon={<ShoppingCart className="w-5 h-5 text-orange-500" />} label="Ventes totales" count={null} active={activeTab==='sales'} onClick={()=>navigateToTab('sales')} />
